...
$(document).ready(function(){   
	tb_init('a.thickbox, area.thickbox, input.thickbox, a.headlabl, a.entlink1');//pass where to apply thickbox
...
function tb_remove() 
{
	var mess = document.getElementById('error_msg');
	if(mess)
	{
		mess.innerHTML = '';	
	}
	
	var at = document.getElementById('box_atention');
	if(at)
	{
		at.innerHTML = '<span class="atentionTxt">Вы должны авторизоваться</span>';	
	}
	
	var reg_mess = document.getElementById('reg_error_msg');
	if(mess)
	{
		reg_mess.innerHTML = '';	
	}
