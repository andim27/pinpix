...
<div class="roundedBlock"><div class="tr"><div class="br"><div class="bl">  
   <div class="photoUpload">
		...
		<div id = "warn" style = "display: none;color:#86BC3F;font-weight:bold" > <?php echo lang ('upload_warn')?></div>
				<div class="uploadNew">
						<?=lang('user_photo_file')?>
						<div class="ent_area_zp progress"><div id="upload_progress"><div id="fileQueue"></div></div></div>															
						
						<input type="file" name="fileInput" id="fileInput"/>
						<!--<input name="" type="button" value="Выбрать" class="button"  />	-->
				</div>

				<div class="uploadNew">			
				<span> <?=lang('user_photo_title')?>
	  			<input id="upload_img_title" class="i" type="text" /> </span>
	  			</div>	
				...
				<span><?=lang('user_photo_erotic')?>
					<input  id="upload_img_erotic" name="erotic_p" class="ch" type="checkbox" /></span>
				<br />
				
				<div class="placeSelector">
	 			<span><?php echo lang('album_cat');?> 
				<select id="upload_img_cat"  class="s">
				...
				<input name=""  type="submit" value="<?= lang('upload'); ?>" class="button" />
...
<div class="highslide-html-content" id="highslide-html" style="width:270px;">
	<div class="highslide-header" style="margin:5px 5px 18px;">
		<div>
			<div style="float: left; color: white; width: 237px;"><h3><?=lang('album_new')?></h3></div>
			<div style="float: right; position: relative; top: 3px;"><img border="0" onclick="return hs.close(this)" src="<?php echo static_url() ?>images/ic_close.gif" title="Close"></div>
		</div>
	</div>
	<div class="highslide-body">
		<div class="roundedBlock" style="background:none;margin-left:5px;margin-right:2px;">
			<form action="<?php echo base_url().'profile/albumedt1/'.$this->db_session->userdata('user_id');	?>">
			<input type="hidden" name="album_id" value="0" />						
			<div class="mb5">
				<div><?php echo lang('album_title');?></div>
				<div><input class="i" type="text" name="title" id="album_title1"  /></div>
			</div>
			
			<div class="mb5">
				<div><?=lang('user_photo_description')?></div>
				<div><textarea class="i" id="short_description1" name="short_description1" cols="" rows=""></textarea></div>
			</div>

			<div class="mb5">			 
				<div><?php echo lang('album_cat');?></div> 
				<div>
	 		...
	 		<div class="mb5">
				<div><?php echo lang('album_rule');?></div>
				<div><select id="view_allowed1"  class="s" name="view_allowed1" onchange="ShowAlbumPwdById(this);">
  			...
  			<div class="mb5">
	  			<div id="album_pwd1" style="display:none;">
					<div><?php echo lang('New_password');?><input id="new_album_pass1" class="i" type="text" name="password" /></div>
					<div><?php echo lang('New_password_confirmation');?></div> 
					<div><input id="new_album_confirm1" class="s" type="text" name="password_confirm" /></div>
		   		</div>
		   	</div>
	   			
		   	<div class="mb5">		  
				<div><?php echo lang('album_erotic');?></div>
				<div><input id="erotic_p1" name="erotic_p1" class="ch" type="checkbox" /></div>
			</div>
			
			<div>
				<input type="button" value="Ok" class="button" onclick = 'if( create_new_album("<?php echo base_url()?>")) return hs.close(this)'/>
