...
$lang['choose_country'] = "Мемлекетті таңдаңыз";
$lang['choose_region'] = "Аймақты таңдаңыз";
$lang['choose_city'] = "Қаланы таңдаңыз";
...
$lang['pict_avatar']     = "Картинка пользователя";
$lang['ready_avatar']    = "Готовые";
$lang['load_avatar']     = "Загрузить картинку(файл jpg,png,gif)";
