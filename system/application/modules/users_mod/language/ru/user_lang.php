<?php
        ...
        $lang['user_login']     = "Мой логин";
        $lang['user_email']     = "Мой email";
        ...
        $lang['error_activation_process'] = "Во время процесса активации возникли ошибки. Пожалуйста, свяжитесь с администратором сайта";
        ...
        $lang['error_activation_info'] = "Неверная активационная информация. Если Вы уже активировали Ваш аккаунт, cпроверьте email и пароль, которые Вы нам отправили, или свяжитесь с администратором сайта";
